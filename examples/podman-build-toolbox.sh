...
podman exec "$container" dnf -y install python3 python3-libdnf5 ||: # Fedora 41+
...
podman commit -c 'LABEL com.github.containers.toolbox="true"' \
    -c 'CMD ["zsh", "-l"]' "$container" "$image"
